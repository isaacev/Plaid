...
func TestEatToken(t *testing.T) {
	...
	expectLexer(t, eatToken, "self", Token{Self, "self", Loc{1, 1}})
	expectLexer(t, eatToken, "use", Token{Use, "use", Loc{1, 1}})
	expectLexer(t, eatToken, "pub", Token{Pub, "pub", Loc{1, 1}})
...
func TestEatOperatorToken(t *testing.T) {
	...
	expectLexer(t, eatOperatorToken, "<", Token{LT, "<", Loc{1, 1}})
	expectLexer(t, eatOperatorToken, "<=", Token{LTEquals, "<=", Loc{1, 1}})
	expectLexer(t, eatOperatorToken, ">", Token{GT, ">", Loc{1, 1}})
	expectLexer(t, eatOperatorToken, ">=", Token{GTEquals, ">=", Loc{1, 1}})
...
func TestEatBrace(t *testing.T) {
	expectLexer(t, eatBraceToken, "{", Token{BraceL, "{", Loc{1, 1}})
...
func TestEatWordToken(t *testing.T) {
	...
	expectLexer(t, eatWordToken, "fn", Token{Fn, "fn", Loc{1, 1}})
	expectLexer(t, eatWordToken, "if", Token{If, "if", Loc{1, 1}})
	expectLexer(t, eatWordToken, "let", Token{Let, "let", Loc{1, 1}})
	expectLexer(t, eatWordToken, "return", Token{Return, "return", Loc{1, 1}})
	expectLexer(t, eatWordToken, "self", Token{Self, "self", Loc{1, 1}})
	expectLexer(t, eatWordToken, "use", Token{Use, "use", Loc{1, 1}})
	expectLexer(t, eatWordToken, "pub", Token{Pub, "pub", Loc{1, 1}})
